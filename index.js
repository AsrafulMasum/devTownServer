...
app.use(
  cors({
    origin: ["http://localhost:5173", "https://devtown-c5563.web.app"],
    credentials: true,
  })
);
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.tw72xpx.mongodb.net/?retryWrites=true&w=majority`;
